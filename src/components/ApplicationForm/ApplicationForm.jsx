          ...
          <form className={css.form} onSubmit={handleSubmit}>
            <fieldset className={css.fieldset}>
              <div className={css.inputWrapper}>
                <label htmlFor="name" className={css.label}>Imię i nazwisko</label>
                <input
              ...
              <div className={css.inputWrapper}>
                <label htmlFor="email" className={css.label}>Adres e-mail</label>
                <input
                  className={`${css.input} ${css.formText}`}
                  type="email"
                  name="email"
              ...
              <div className={css.inputWrapper}>
                <label htmlFor="city" className={css.label}>Miejscowość</label>
                <input
                  className={`${css.input} ${css.formText}`}
                  type="text"
                  name="city"
              ...
              <div className={css.inputWrapper}>
                <label htmlFor="role" className={css.label}>Rola</label>
                <select
                  className={`${css.input} ${css.formText}`}
                  name="role"
                  id="role"
            ...
            <div className={css.bottomArea}>
              ...
              <p className={css.formText}>Podczas konferencji będzie zagwarantowany ciepły posiłek. Prosimy o wybór menu zgodnie
