  ...
  return (
    ...
    >
      <div className={css.BeAVolunteerContainer}>
        <img className={css.BeAVolunteerImg} src={BeAVolunteerImage} alt={''} />
        <div className={css.BeAVolunteerTextContainer}>
          <p className={css.BeAVolunteerText}>
            ...
            się do edukacji i świadomości w ważnej kwestii uzależnienia dzieci i
            młodzieży od ekranów, chcesz pomóc w dotarciu do szerokiego grona
            odbiorców wydarzenia, chcesz wesprzeć swoją aktywnością organizację
